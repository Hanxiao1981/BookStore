...
namespace Taihang.BookStore.Net
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public ApplicationUserManager(IUserStore<ApplicationUser,string> store) : base(new UserStore<ApplicationUser>())
        {
            Store = store;
        }
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            var userStore = new UserStore<ApplicationUser, ApplicationRole, string, IdentityUserLogin, IdentityUserRole, IdentityUserClaim>(context.Get<ApplicationDbContext>());                       
